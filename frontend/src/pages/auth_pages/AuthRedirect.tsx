...
const AuthRedirect = ({ username }: AuthRedirectProps) => {
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center flex-col gap-10 h-[100vh] mx-25">
                <div className="flex-row md:text-6xl text-4xl bg-slate-50 rounded-2xl px-2 py-2 shadow-lg "><span className='font-bold'>Congratulations:</span> {username}</div>
                <div className="flex-row md:text-2xl text-md bg-black text-white font-semibold rounded-2xl px-2 py-2 shadow-lg">Your Email is <span className='underline underline-offset-4 font-bold'>now</span> verified</div>
